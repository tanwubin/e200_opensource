...
SIM_OPTIONS   := -full64 -cpp g++-4.8 -cc gcc-4.8 -LDFLAGS -Wl,--no-as-needed -line +vcsd +vpi -r +plusarg_save -Mupdate +cli+3 +error+10 +v2k +ntb_exit_on_error=10 -negdelay +neg_tchk +memcbk +sdrverbose -timescale=1ns/100ps +warn=all +warn=noTFIPC +warn=noWSUM -sverilog -l vcs.log -LDFLAGS -rdynamic -P ${VERDI_HOME}/share/PLI/VCS/LINUXAMD64/novas_new_dumper.tab ${VERDI_HOME}/share/PLI/VCS/LINUXAMD64/pli.a +incdir+${VSRC_DIR}/core/+${VSRC_DIR}/perips/
